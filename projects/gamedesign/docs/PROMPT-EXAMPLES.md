...
| 에셋 타입 | 방향 | 비율 | 구도 | 볼 홍조 |
|-----------|------|------|------|---------|
| 캐릭터 | 우측 대각선 ↗ | 2:3 세로형 | 전신 (head to feet) | O |
| 동료 | 우측 대각선 ↗ | **1:1 정사각 (원형 프레임)** | 상반신/얼굴 클로즈업 | O |
...
| `frame-companion` | 동료 프레임 | 시안 #00BCD4 | 동료 크리처 (**원형 1:1, 96×96px**) |
...
- [ ] **방향**: 캐릭터 → 우측 ↗ / 몬스터 → 좌측 ↖
- [ ] **볼 홍조**: 캐릭터/동료 → O / 몬스터 → X
- [ ] **비율**: 캐릭터/몬스터 2:3 / 동료 1:1 정사각 (원형 프레임) / 배경 16:9
