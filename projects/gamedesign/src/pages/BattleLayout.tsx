...
const ZONES = [
  { id: 'A', name: '상단 HUD', y: 0, h: 72, color: '#D4A574', description: '진행 상황, 자원 표시 (6.7%)' },
  { id: 'B', name: '전투 무대', y: 72, h: 848, color: '#4A90C0', description: '전투 캐릭터, 코인 조작, 이펙트 (78.5%)' },
    ...
    <div className="relative w-full" style={{ aspectRatio: '16/9' }}>
      ...
      <div className="absolute inset-0 rounded-lg overflow-hidden" style={{ backgroundColor: '#16161C' }}>
        ...
        <div
          ...
          style={{ left: toPercent(720, 1920), top: toPercent(79, 1080) }}
        >
