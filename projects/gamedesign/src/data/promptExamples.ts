...
cute friendly, cheerful bright`
    },
    {
      ...
      group: '캐릭터 프레임',
      prompt: `game UI frame design for fantasy RPG companion creature,
empty circular frame template without creature illustration,
perfect circle shape 1:1 ratio,
round medallion badge design,

dark charcoal frame background #1E1E24,
deep gray inner area #2A2A32,
soft graphite pencil texture circular border #4A4A55,
hand-drawn sketch edge with subtle irregularity,
perfectly round border no corners,

mystical cyan glow accent #00BCD4,
subtle cyan rim light effect around circular border,
...
circular crop area for bust or face close-up,
professional game UI asset,
2D flat design,
isolated on solid white background,
...
close-up bust and face composition,
centered in circular crop area,
creature head and upper body fills frame,
